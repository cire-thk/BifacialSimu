...
reflectivity = np.genfromtxt(rootPath +'/Quartz_GDS74_BECKr_edit_all_wavelength.csv', delimiter=';', skip_header = 1, usecols=(1))
...
df.to_csv('interpolated_reflectivity.csv', sep=';', index=False)
