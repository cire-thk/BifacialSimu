...
'''LOCAL_DIR = os.getcwd()
DATA_DIR = os.path.join(LOCAL_DIR, 'D:\Krempel\FH\Python\Simulationsergebnisse\WeatherData\Golden_USA')
resultsPath = os.path.join(DATA_DIR, 'SRRL Weatherdata.csv')'''
...
#########################################################
#pvrow_height = clearence_height + (math.sin(tilt)*pvmodule_height/2)
