...
class Electrical_simulation:
    ...
    def build_simulationReport(df_reportVF, df_reportRT, simulationDict, WireDict, inverterDict, resultsPath):
    ...
    def simulate_oneDiode(moduleDict, simulationDict, WireDict, inverterDict, df_reportVF, df_reportRT, df_report, df, resultsPath):
        ...
        df_report = Electrical_simulation.build_simulationReport(df_reportVF, df_reportRT, simulationDict, WireDict, inverterDict, resultsPath)
        ...
        if 'time' not in df_report.columns:    
            df_report['time'] = df_report.index
        ...
        for i in tqdm(range(0, simulationDict['nRows'])):
            ...
            # Append I_sc_b_hourly array to arrays
