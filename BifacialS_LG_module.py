...
simulationParameter = {
    ...
    'albedo': 0.205243016, # Measured Albedo average value
    ...
    #'L_Position': -0.693861, #Longitude of measurement position [deg]
    ...
    #'Latitude_Position': 10.362861, #Latitude of measurement position [deg]
